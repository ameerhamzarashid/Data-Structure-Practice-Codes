...
class TreeNode {
  ...
  public:
  	// it is key that represents the value
    int value;
    // paths of tree 
  TreeNode * left;
  TreeNode * right;
 // constructor that create a node below root node
  TreeNode() {
    value = 0;
    left = NULL;
    right = NULL;
  }
  // constructor that we create above below root node now taking value
  TreeNode(int v) {
    value = v;
    left = NULL;
    right = NULL;
 ...
 // just check that either root node is created 
class BST {
  public:
    TreeNode * root;
  BST() {
